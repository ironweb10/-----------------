...
var DataForms = /*#__PURE__*/Object.freeze({
    __proto__: null,
...
function Messaging (client) {
    ...
    client.sendMarker = (msg, marker, force) => {
        ...
        if (msg.type === 'groupchat' && msg.stanzaIds && useStanzaID) {
            const mucStanzaId = msg.stanzaIds.find(s => equalBare(s.by, msg.from));
            if (mucStanzaId) {
                id = mucStanzaId.id;
            }
        }
        client.sendMessage({
            ...
            to: msg.type === 'groupchat' ? toBare(msg.from) : msg.from,
            type: msg.type
        });
    };
    client.on('message', msg => {
...
class ResultSetPager {
    ...
    fetchPage() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const { results, paging } = yield this.query({
...
var RSM = /*#__PURE__*/Object.freeze({
    __proto__: null,
    ResultSetPager: ResultSetPager,
...
export { Client, Constants, DataForms, JID, index$3 as JXT, index$1 as Jingle, Namespaces, RSM, RTT, index$2 as SASL, index as Stanzas, Utils, VERSION, core, createClient, getHostMeta };
