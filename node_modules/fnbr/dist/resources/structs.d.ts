...
export declare type StringFunctionAsync = () => Promise<string>;
...
export declare type DeviceAuthFunction = () => DeviceAuth;
export declare type DeviceAuthFunctionAsync = () => Promise<DeviceAuth>;
export declare type DeviceAuthResolveable = DeviceAuth | PathLike | DeviceAuthFunction | DeviceAuthFunctionAsync;
export declare type AuthStringResolveable = string | PathLike | StringFunction | StringFunctionAsync;
export declare type Platform = 'WIN' | 'MAC' | 'PSN' | 'XBL' | 'SWT' | 'IOS' | 'AND';
export declare type AuthClient = 'fortnitePCGameClient' | 'fortniteIOSGameClient' | 'fortniteAndroidGameClient' | 'fortniteSwitchGameClient' | 'fortniteCNGameClient' | 'launcherAppClient2' | 'Diesel - Dauntless';
...
export declare type PresenceOnlineType = 'away' | 'chat' | 'dnd' | 'xa' | 'online';
...
export declare type AuthType = 'fortnite' | 'fortniteClientCredentials' | 'launcher';
...
export declare type PendingFriendDirection = 'INCOMING' | 'OUTGOING';
...
export declare type CosmeticEnlightment = [number, number];
...
export declare type Region = 'EU' | 'NAE' | 'NAW' | 'BR' | 'ME' | 'ASIA' | 'OCE';
export declare type FullPlatform = 'Windows' | 'Android' | 'PS4' | 'XboxOne' | 'XSX' | 'PS5' | 'Switch' | 'Windows' | 'Mac';
export declare type SentMessageType = 'PARTY' | 'FRIEND';
...
export declare type UserSearchPlatform = 'epic' | 'psn' | 'xbl';
export declare type UserSearchMatchType = 'exact' | 'prefix';
...
export declare type ReplayDataType = 'EVENT' | 'DATACHUNK' | 'CHECKPOINT';
...
export declare type Language = 'ar' | 'en' | 'de' | 'es' | 'fr' | 'it' | 'ja' | 'pl' | 'ru' | 'tr';
